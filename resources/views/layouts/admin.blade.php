...
<head>
    ...
    <title>@yield('title', 'Dashboard Admin') | Sistem Absensi EWF</title>
...
<body>
    ...
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li>
                <a href="{{ route('admin.leaders.index') }}" class="{{ request()->is('admin/leaders*') ? 'active' : '' }}">
                    <i class="bi bi-person-badge-fill"></i>
                    <span>Ketua Ruangan</span>
                </a>
            </li>
    ...
    <div class="content">
        ...
        <div class="topbar">
            <div class="topbar-left">
                <h5 class="fw-bold mb-0">@yield('page-title', 'Dashboard Admin')</h5>
