...
<head>
    ...
    <title>@yield('title', 'Dashboard Ketua Ruangan') | Sistem Absensi EWF</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        /* =========================================
        TABLE STYLE ADMIN & LEADER
        Header tengah, isi menyesuaikan seperti contoh
        ========================================= */
        ...
        /* Kolom pertama (biasanya ID / nomor) rata tengah */
        ...
        /* Kalau ada kolom aksi, buat tetap di tengah */
        ...
        /* Tombol / link aksi di tengah */
        .table td.table-actions .d-flex,
        .table td.actions-column .d-flex {
        ...
        .table td.actions-column form {
            display: inline-block;
            margin: 0;
        }

        /* Email / teks kecil di bawah nama */
        .table td small {
            display: block;
            margin-top: 4px;
            color: #6b7280;
        ...
        /* Badge status tetap di tengah */
        .table td.status-column .badge {
            display: inline-flex;
            align-items: center;
            justify-content: center;
        }
...
<body>
    ...
    <aside class="sidebar">
        <div class="sidebar-profile">
            ...
            <h6>{{ $user->name }}</h6>
            <small>Ketua Ruangan</small>
        </div>
        <ul class="sidebar-menu">
            <li>
                <a href="{{ route('leader.dashboard') }}" class="{{ request()->routeIs('leader.dashboard') ? 'active' : '' }}">
                    <i class="bi bi-grid-1x2-fill"></i>
                    <span>Dashboard</span>
                </a>
            </li>
            <li>
                <a href="{{ route('leader.employees.index') }}" class="{{ request()->routeIs('leader.employees.*') ? 'active' : '' }}">
                    <i class="bi bi-people-fill"></i>
                    <span>Data Karyawan Divisi</span>
                </a>
            </li>
            <li>
                <a href="{{ route('leader.attendances.index') }}" class="{{ request()->routeIs('leader.attendances.*') ? 'active' : '' }}">
                    <i class="bi bi-calendar-check-fill"></i>
                    <span>Data Absensi Divisi</span>
                </a>
            </li>
            <li>
                <a href="{{ route('leader.reports.index') }}" class="{{ request()->routeIs('leader.reports.*') ? 'active' : '' }}">
    ...
    <div class="content">
        ...
        <div class="topbar">
            <div class="topbar-left">
                <h5 class="fw-bold mb-0">@yield('page-title', 'Dashboard Ketua Ruangan')</h5>
                ...
                headers.forEach(function (header, index) {
                    ...
                    if (headerText.includes('status')) {
                        ...
                        rows.forEach(function (row) {
                            ...
                            if (cells[index]) {
                                cells[index].classList.add('status-column');
                            }
                        });
                    }
                });
