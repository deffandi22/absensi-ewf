...
@section('title', 'Dashboard Ketua Ruangan')
@section('page-title', 'Dashboard Ketua Ruangan')

@section('content')
    <div class="mb-4">
        <h3 class="fw-bold mb-1">Dashboard Ketua Ruangan</h3>
        <p class="text-muted mb-0">
            Monitoring absensi karyawan pada divisi
        ...
        <div class="col-md-6 col-xl">
            <div class="card stat-card h-100">
                <div class="card-body d-flex align-items-center justify-content-between p-4">
                    <div>
                        <p class="text-muted mb-1">Karyawan Divisi</p>
            ...
            <div class="card stat-card h-100">
                <div class="card-body d-flex align-items-center justify-content-between p-4">
                    <div>
                        ...
                        <h3 class="fw-bold mb-0">{{ $attendanceToday }}</h3>
                    </div>
            ...
            <div class="card stat-card h-100">
                <div class="card-body d-flex align-items-center justify-content-between p-4">
                    <div>
                        ...
                        <h3 class="fw-bold mb-0">{{ $lateToday }}</h3>
                    </div>
            ...
            <div class="card stat-card h-100">
                <div class="card-body d-flex align-items-center justify-content-between p-4">
                    <div>
                        ...
                        <h3 class="fw-bold mb-0">{{ $notAttendToday }}</h3>
                    </div>
    ...
    <div class="row g-4">
        <div class="col-xl-8">
            <div class="card table-card h-100">
                <div class="card-body p-4">
                    <div class="mb-4">
                        <h5 class="fw-bold mb-1">Absensi Terbaru Divisi</h5>
                        <p class="text-muted mb-2 small">Data absensi terakhir dari karyawan divisi.</p>
                        <a href="{{ route('leader.attendances.index') }}" class="btn btn-sm btn-primary rounded-pill px-3">
                            Lihat Semua
                        </a>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="text-center text-muted py-5">Belum ada data absensi terbaru.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
        ...
        <div class="col-xl-4">
            <div class="card table-card mb-4">
                <div class="card-body p-4">
                    <h5 class="fw-bold mb-3">Informasi Divisi</h5>
                    <div class="d-flex justify-content-between border-bottom py-3 gap-3">
                        <span class="text-muted">Role Aktif</span>
                        <span class="fw-semibold text-end">Ketua Ruangan</span>
                    </div>
                    <div class="d-flex justify-content-between border-bottom py-3 gap-3">
                        <span class="text-muted">Divisi</span>
                        <span class="fw-semibold text-end">{{ $leader->division->division_name ?? '-' }}</span>
                    </div>
                    <div class="d-flex justify-content-between border-bottom py-3 gap-3">
            ...
            <div class="card border-0 rounded-4 shadow-sm" style="background: linear-gradient(135deg, #1d4ed8, #0f172a);">
                <div class="card-body p-4 text-white">
                    <h5 class="fw-bold mb-2">Monitoring Absensi Divisi</h5>
                    <p class="mb-4 opacity-75">Dashboard ini digunakan untuk memantau data karyawan dan absensi pada divisi yang dipimpin.</p>
                    <div class="d-flex align-items-center gap-2">
                        <i class="bi bi-shield-check"></i>
                        <small>Akses data dibatasi sesuai divisi</small>
                    </div>
                </div>
            </div>
        </div>
