...
@section('content')
    <div class="mb-4">
        ...
        <p class="text-muted mb-0">Perbarui data akun dan profil karyawan.</p>
    </div>
            ...
            <form action="{{ route('admin.employees.update', $employee) }}" method="POST">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="password" name="password" class="form-control rounded-4" placeholder="Kosongkan jika tidak diganti">
                    </div>
                        ...
                        <select name="division_id" class="form-select rounded-4" required>
                            ...
                            @foreach ($divisions as $division)
                                <option value="{{ $division->id }}"
                                    {{ old('division_id', $employee->user->division_id) == $division->id ? 'selected' : '' }}>
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="address" class="form-control rounded-4" rows="4">{{ old('address', $employee->address) }}</textarea>
                    </div>
                </div>
