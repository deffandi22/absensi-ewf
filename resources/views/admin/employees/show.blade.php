...
@section('content')
    @php
        $profilePhoto = $employee->user && $employee->user->profile_photo
            ? asset('storage/' . $employee->user->profile_photo)
            : null;
    @endphp

    <div class="mb-4">
        <h3 class="fw-bold mb-1">Detail Karyawan</h3>
        <p class="text-muted mb-2">Informasi lengkap data karyawan.</p>
                ...
                <div class="col-md-8">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="fw-semibold">{{ $employee->user->division->division_name ?? '-' }}</div>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-4">
                        <a href="{{ route('admin.employees.edit', $employee) }}" class="btn btn-primary rounded-pill px-4">
