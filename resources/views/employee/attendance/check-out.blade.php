...
@section('page-title', 'Check-out Karyawan')

@section('content')
    <div class="mb-4">
        <h3 class="fw-bold mb-1">Check-out Karyawan</h3>
        <p class="text-muted mb-0">
            Ambil foto realtime dan izinkan lokasi untuk menyimpan absensi pulang.
        </p>
    </div>
    ...
    <div class="row g-4">
            ...
            <div class="card dashboard-card">
                <div class="card-body p-4">
                    ...
                    <div class="alert alert-warning rounded-4 mt-4 mb-0 small">
                        Foto check-out harus diambil langsung melalui kamera. Sistem tidak menyediakan upload dari galeri.
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-4">
            <div class="card dashboard-card mb-4">
                <div class="card-body p-4">
                    <h5 class="fw-bold mb-3">Informasi Check-in</h5>
                    ...
                    <div class="d-flex justify-content-between py-3 gap-3">
                        ...
                        <span class="fw-semibold text-end">
                            {{ $todayAttendance->check_in_time ? $todayAttendance->check_in_time . ' WIB' : '-' }}
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div class="card dashboard-card">
                <div class="card-body p-4">
                    <h5 class="fw-bold mb-3">Lokasi Check-out</h5>

                    <div class="alert alert-info rounded-4 border-0 small mb-3">
                        <i class="bi bi-info-circle-fill me-1"></i>
                        Pastikan lokasi Anda berada dalam radius kantor sebelum menyimpan check-out.
                    </div>
                    ...
                    <form action="{{ route('employee.checkout.store') }}" method="POST" class="mt-4" id="checkOutForm">
                        @csrf
                        ...
                        <button type="submit" class="btn btn-primary rounded-pill px-4 w-100" id="submitCheckOut" disabled>
    ...
    <script>
        ...
        function checkFormReady() {
            submitCheckOutBtn.disabled = !(photoInput.value && latitudeInput.value && longitudeInput.value);
        }
        ...
        document.getElementById('checkOutForm').addEventListener('submit', function (e) {
            if (!photoInput.value || !latitudeInput.value || !longitudeInput.value) {
                e.preventDefault();
                alert('Foto dan lokasi wajib diambil sebelum menyimpan check-out.');
                return;
            }

            submitCheckOutBtn.disabled = true;
            submitCheckOutBtn.innerHTML = '<i class="bi bi-hourglass-split me-1"></i> Menyimpan...';
        });
