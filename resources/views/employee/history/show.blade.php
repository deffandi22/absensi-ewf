...
@section('title', 'Detail Riwayat Absensi')
...
@section('content')
    ...
    <div class="mb-4 d-flex flex-wrap justify-content-between align-items-center gap-3">
        <div>
            <h3 class="fw-bold mb-1">Detail Riwayat Absensi</h3>
            <p class="text-muted mb-0">
                Informasi lengkap absensi pribadi karyawan.
            </p>
        </div>
        ...
        <div class="col-lg-8">
            ...
            @if (($attendance->verification_status ?? 'valid') === 'ditolak')
                <div class="alert alert-danger rounded-4 border-0 mt-4">
                    Absensi ini telah <strong>ditolak oleh Ketua Ruangan</strong>. Silakan perhatikan alasan penolakan yang tertera pada detail absensi.
                </div>
            @elseif ($attendance->status === 'terlambat')
                <div class="alert alert-danger rounded-4 border-0 mt-4">
                    Anda melakukan check-in melewati batas waktu yang ditentukan, sehingga status absensi ditandai sebagai <strong>Terlambat</strong>.
                </div>
            @endif
        </div>
    </div>
